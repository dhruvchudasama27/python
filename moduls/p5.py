...
ind_bc = 0
ind_run = 0
while count < ind_ab_length - 7:
    ind_bc = ind_ab[count].find_all('div',{'class':'cb-col cb-col-25'})
    ind_cd = ind_bc[0].find_all('a',{'class':'cb-text-link'})
    ind_run = ind_ab[count].find_all('div',{'class':'cb-col cb-col-8 text-right text-bold'})
